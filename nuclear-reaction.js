(function () {
  ...
  window.nuclearReactionLab={solveChain:(next={})=>model.chainState({...state,...next}),solveFusion:(next={})=>model.fusionState({...state,...next}),getState:()=>({...state}),setMode,setState:(next={})=>{Object.assign(state,next);render();},reset};
