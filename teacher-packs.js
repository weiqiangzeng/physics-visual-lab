(function () {
  ...
  const packs = [
    ...
    {
      lesson: "electric-field.html", slug: "electric-field", title: "电场与电势：用等势线读懂电场方向", module: "电场与电荷", grade: "必修第三册", duration: 15, lessonUse: "概念辨析",
      ...
      presets: [["single", "单电荷探针", "区分 E、F、V、U", { mode: "single", q1: 6, q2: -6, separation: 3, testCharge: 2, probeX: 2.4, probeY: 1.2, showFieldLines: false, showVectors: false, showEquipotential: true, showForce: true, showPotentialMap: true }], ["dipole", "偶极中垂线", "V=0 但 E 不为零", { mode: "superposition", q1: 6, q2: -6, separation: 3, testCharge: 2, probeX: 0, probeY: 2, showFieldLines: false, showVectors: false, showEquipotential: true, showForce: true }], ["same-sign", "同号电荷中点", "E=0 但 V 不为零", { mode: "potential", q1: 6, q2: 6, separation: 3, testCharge: 2, probeX: 0, probeY: 0, showFieldLines: false, showVectors: false, showEquipotential: true, showForce: true, showPotentialMap: true }]],
    ...
    {
      lesson: "charged-particle.html", slug: "charged-particle", title: "带电粒子：先分场比较，再拓展到复合场", module: "磁场与电磁感应", grade: "必修第三册", duration: 15, lessonUse: "模型对比",
      ...
      presets: [["electric", "纯电场类平抛", "电场力做功并改变速率", { mode: "electric", charge: 1, mass: 1.5, electric: 3, magnetic: 0, speed: 4, angle: 0, showTrail: true, showVectors: true, showField: true, showDecomposition: false }], ["magnetic", "纯磁场圆周", "力垂直速度，速率不变", { mode: "magnetic", charge: 1, mass: 1.5, electric: 0, magnetic: 0.8, speed: 4, angle: 0, showTrail: true, showVectors: true, showField: true }], ["selector", "速度选择器", "配平 qE 与 qvB", { mode: "selector", charge: 1, mass: 1.5, electric: 8, magnetic: 0.8, speed: 1, angle: 0, showTrail: true, showVectors: true, showField: true, showDecomposition: false }]],
    ...
    {
      lesson: "double-slit.html", slug: "double-slit", title: "双缝干涉：从条纹测量到单光子拓展", module: "光学", grade: "选择性必修第一册", duration: 15, lessonUse: "宏微观统一",
      ...
      presets: [["spacing", "红光标准条纹", "测量中央附近条纹间距", { mode: "spacing", wavelength: 600, slit: 0.3, slitWidth: 0.06, screen: 1.2, cursorRatio: 0, showRays: false, showWaves: true, showEnvelope: false, showLabels: true, whichPath: false, photonRate: 20 }], ["path", "一级暗纹探针", "用 Δr/λ 判断相消", { mode: "path", wavelength: 600, slit: 0.3, slitWidth: 0.06, screen: 1.2, cursorRatio: 0.5, showRays: false, showWaves: true, showEnvelope: false, showLabels: true, whichPath: false }], ["photon", "单光子拓展", "从离散事件形成统计条纹", { mode: "photon", wavelength: 600, slit: 0.3, slitWidth: 0.06, screen: 1.2, cursorRatio: 0, showRays: false, showWaves: true, showEnvelope: false, showLabels: true, whichPath: false, photonRate: 60 }]],
    ...
    },
    {
      ...
      presets: [["micro", "微观碰撞", "观察速度分布与压强取样", { mode: "microscopic", amount: 0.1, baseVolume: 10, baseTemperature: 300, species: "nitrogen", progress: 0, playbackRate: 0.5, showVelocity: true, showTrails: false, showCollisions: true, showPressure: true, showSample: true }], ["heat", "定容升温", "速度和压强同步增大", { mode: "isochoric", amount: 0.1, baseVolume: 10, baseTemperature: 300, species: "nitrogen", progress: 1, playbackRate: 0.5, showVelocity: true, showTrails: false, showCollisions: true, showPressure: true, showSample: true }], ["compress", "等温压缩", "速度尺度不变、碰壁频率增大", { mode: "isothermal", amount: 0.1, baseVolume: 10, baseTemperature: 300, species: "nitrogen", progress: 1, playbackRate: 0.5, showVelocity: true, showTrails: false, showCollisions: true, showPressure: true, showSample: true }]],
