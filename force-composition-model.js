(function (root, factory) {
  ...
  function normalize(input = {}) {
    return {
      ...
      direction1Deg: clamp(input.direction1Deg ?? 0, -180, 180),
      direction2Deg: clamp(input.direction2Deg ?? 90, -180, 180),
      direction3Deg: clamp(input.direction3Deg ?? -120, -180, 180),
      targetForceN: clamp(input.targetForceN ?? 10, .5, 30),
      targetDirectionDeg: clamp(input.targetDirectionDeg ?? 53.13010235415598, -180, 180),
